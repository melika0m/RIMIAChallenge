...
from tensorflow.keras.layers import Dense, Dropout, Reshape, GlobalAveragePooling2D # type: ignore
...
# Step 3: Build the Model using DenseNet121
def build_model():
...
def train_model(model, X_train, y_train, X_val, y_val):
    ...
    model.save('densenet_license_plate_model.h5')
...
if __name__ == '__main__':
    ...
    # Generate submission
    generate_submission_corrected(model, test_dir, 'densenet_submission.csv')
